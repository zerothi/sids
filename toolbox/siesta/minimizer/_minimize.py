...
class BaseMinimize:
    ...
    def __init__(self, runner, metric, variables=(), out="minimize.dat", norm=('l2', 1.)):
        ...
        if variables is not None:
            for v in variables:
                self.add_variable(v)
        # open the file 'out' cleared for writing
        self.out = Path(out)
    ...
    def _minimize_func(self, norm_variables, *args):
        ...
        *args :
        ...
        try:
            ...
            print(f"Using a prior hashed calculation {idx}", flush=True)
